module.exports = {
	...
	rules: {
		...
		"id-denylist": ["error", "e", "el", "ele", "obj", "cb", "val"],
		"id-length": ["error", { min: 3, max: 30, exceptionPatterns: ["[A-Z_]+", "id", "in", "rg", "qb"] }],
		...
		"@typescript-eslint/consistent-type-assertions": ["error", { assertionStyle: "angle-bracket", objectLiteralTypeAssertions: "never" }],
		"@typescript-eslint/consistent-type-definitions": ["error", "interface"],
		"@typescript-eslint/consistent-type-imports": "error",
		"@typescript-eslint/explicit-function-return-type": ["error", { allowExpressions: true, allowDirectConstAssertionInArrowFunctions: false }],
		...
		"@typescript-eslint/naming-convention": [
			...
			},
			{
				...
				format: ["camelCase", "UPPER_CASE"],
				custom: {
					regex: "^(is|IS|should|SHOULD|has|HAS|can|CAN|did|DID|will|WILL|was|WAS)[a-zA-Z_]",
					match: true,
				},
			},
		],
